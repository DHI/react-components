 ...
 */
class AisCompositeLayerV2 extends CompositeLayer<any, any> {
      ...
      new TileLayer({
        ...
        renderSubLayers: (props: any) => {   
          ...
          return new GeoJsonLayer(props, {
            ...
            visible: true,
            updateTriggers: {
              getFillColor: triggerLayerUpdate,
              getLineColor: triggerLayerUpdate,
            }
          });
        },
        updateTriggers: {
          renderSubLayers: triggerLayerUpdate,
        }
      }),
      zoom >= 12 ?
        new TileLayer({
          ...
          renderSubLayers: (props: any) => {
            ...
            return new TextLayer({
              ...
              getSize: 12,
              updateTriggers: {
                getColor: triggerLayerUpdate,
                getBackgroundColor: triggerLayerUpdate,
              }
            })
          },
          updateTriggers: {
...
AisCompositeLayerV2.layerName = "AisLayerV2";

export { AisCompositeLayerV2 };
