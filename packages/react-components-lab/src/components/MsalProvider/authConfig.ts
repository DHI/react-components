...
export const msalConfig: Configuration = {
  auth: {
    ...
    authority:
      'https://login.microsoftonline.com/4c2ebde0-11c8-45fa-9a22-3be5b8203a88',
    redirectUri: '/',
  },
};
...
export const DSConfig = {
  dfs0TimeSeries:
    'https://me-test-brain.westeurope.cloudapp.azure.com/mikecloudsamplewebapi/api/timeseries/dfs0-timeseries',
};
