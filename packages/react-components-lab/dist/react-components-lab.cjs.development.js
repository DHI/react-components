...
var CheckCircleOutlinedIcon = _interopDefault(require('@mui/icons-material/CheckCircleOutlined'));
var ReportProblemOutlinedIcon = _interopDefault(require('@mui/icons-material/ReportProblemOutlined'));
var ErrorOutlineOutlinedIcon = _interopDefault(require('@mui/icons-material/ErrorOutlineOutlined'));
var utils = require('@mui/utils');
var CssBaseline = _interopDefault(require('@mui/material/CssBaseline'));

var ImgLegendStyled = /*#__PURE__*/styles.styled('img')({
  width: '100%',
  height: 6,
  borderRadius: 4
});
...
var BarLegend = function BarLegend(_ref) {
  ...
  return React__default.createElement(material.Box, {
    width: 1
  }, React__default.createElement(ImgLegendStyled, {
    src: src,
    alt: "legend-colorbar",
    theme: theme
  }), range && (typeof range[0] === 'number' && typeof range[1] === 'number' && val ? React__default.createElement(material.Box, {
    display: "flex",
    justifyContent: "space-between"
  }, val.map(function (v) {
    return React__default.createElement(material.Typography, {
      key: "value-" + v,
      sx: {
        fontSize: 10
      }
    }, v + " " + unit);
  })) : ['number', 'string'].includes(typeof range[0]) && ['number', 'string'].includes(typeof range[1]) && React__default.createElement(material.Box, {
    display: "flex",
    justifyContent: "space-between"
  ...
  }, range[0] + " " + unit), React__default.createElement(material.Typography, {
    sx: {
      fontSize: 10
    }
  }, range[1] + " " + unit))));
...
var CalendarBox = function CalendarBox(_ref) {
  var children = _ref.children,
      title = _ref.title;
  return React__default.createElement(material.Box, null, title && React__default.createElement(material.Typography, {
    variant: "h5",
    gutterBottom: true
...
var CalendarItemBox = /*#__PURE__*/styles.styled(material.Box, options)(function (_ref) {
  ...
  return system.experimental_sx(stableCss);
});
...
var CalendarItem = function CalendarItem(_ref) {
  ...
  return React__default.createElement(CalendarItemBox, {
...
var CardRootStyled = /*#__PURE__*/styles.styled(material.Card)({
  borderRadius: 4,
  marginTop: 12,
  marginBottom: 15,
  position: 'relative'
...
var BoxDisabledStyled = /*#__PURE__*/styles.styled(material.Box)( /*#__PURE__*/system.experimental_sx({
  position: 'absolute',
  top: 0,
  left: 0,
  zIndex: 100,
...
var ImgCardStyled = /*#__PURE__*/styles.styled('img')({
  width: '90%',
  height: 'auto'
});
...
var Card = function Card(_ref) {
  ...
  console.log(theme);
  return React__default.createElement(CardRootStyled, {
    variant: "outlined"
  }, disabled && React__default.createElement(BoxDisabledStyled, null), React__default.createElement(material.Box, {
    px: 2,
    py: 1.5
  ...
  }, title), subTitle && React__default.createElement(material.Typography, {
    variant: "subtitle1",
    sx: {
      fontSize: 12,
      color: 'darkGrey.main'
    }
  }, subTitle)), React__default.createElement(material.Box, {
    display: "flex",
    ...
    alignItems: "center",
    justifyContent: "center"
  }, React__default.createElement(ImgCardStyled, {
    src: image,
    alt: image
  })), isClickable && React__default.createElement(material.Box, {
    display: "flex",
    alignItems: "center"
  }, customCheckbox ? React.cloneElement(customCheckbox, {
    checked: isOpen
  }) : React__default.createElement(material.Checkbox, {
    checked: isOpen,
    disabled: disabled,
    icon: React__default.createElement(iconsMaterial.RadioButtonUnchecked, {
      color: "primary",
      sx: {
        width: 26,
        height: 26,
    ...
    checkedIcon: React__default.createElement(iconsMaterial.CheckCircle, {
      sx: {
        width: 26,
        height: 26,
    ...
    return React.Children.toArray(React__default.createElement(material.Typography, {
      align: "justify",
      variant: "body2",
      gutterBottom: true,
      sx: {
...
var CategoricalBarLegend = function CategoricalBarLegend(_ref) {
  ...
  return React__default.createElement(material.Box, {
    ...
    }), Boolean(legendItem.label) && React__default.createElement(material.Box, {
      ml: 1,
      width: "50%"
    }, React__default.createElement(material.Typography, {
      variant: "body2",
...
var CollapsableBox = function CollapsableBox(_ref) {
  ...
  return React__default.createElement(material.Box, {
    ...
    p: 1
  }, children)), React__default.createElement(material.Box, {
    display: "flex",
    justifyContent: "center"
    ...
    fullWidth: true
  }, React__default.createElement(iconsMaterial.ExpandMore, {
    sx: {
...
var ButtonBaseStyled = /*#__PURE__*/styles.styled(material.ButtonBase)(function (_ref) {
...
var RootBoxStyled = /*#__PURE__*/styles.styled(material.Box)(function (_ref) {
  var theme = _ref.theme;
  return {
...
var ArrowDownIconStyled = /*#__PURE__*/styles.styled(KeyboardArrowDownIcon)(function (_ref) {
  var theme = _ref.theme;
  return {
    width: 24,
    height: 24,
...
var ColorBoxStyled = /*#__PURE__*/styles.styled(material.Box)(function (_ref) {
  var theme = _ref.theme;
  return {
    width: 22,
    height: 22,
...
var TruncateTypographyStyled = /*#__PURE__*/styles.styled(material.Typography)({
  whiteSpace: 'nowrap',
  overflow: 'hidden',
...
var LegendBase = function LegendBase(_ref) {
  ...
  return React__default.createElement(RootBoxStyled, {
    sx: _extends({}, positionStylesMap[position], {
      boxShadow: collapsed && 'unset'
    })
  }, React__default.createElement(ButtonBaseStyled, {
    disabled: !collapsable,
    onClick: toggleCollapsed
  }, React__default.createElement(TruncateTypographyStyled, null, title), collapsable && React__default.createElement(ArrowDownIconStyled, {
    sx: {
    ...
    "in": !collapsed
  }, unit && React__default.createElement(material.Box, {
    display: "flex",
    justifyContent: "flex-end",
    mx: 1
  }, React__default.createElement(material.Typography, {
    variant: "subtitle2"
  }, unit), React__default.createElement(ColorBoxStyled, null)), React__default.createElement(material.Box, {
    sx: {
      margin: 1
    }
  }, children))));
...
var StaticLegend = function StaticLegend(_ref) {
  var items = _ref.items,
      ...
      _ref$collapsable = _ref.collapsable,
      collapsable = _ref$collapsable === void 0 ? false : _ref$collapsable;
  return React__default.createElement(LegendBase, {
    unit: unit,
    title: title,
    position: position,
    ...
    return React__default.createElement(material.Box, {
      ...
      justifyContent: "space-between",
      width: "100%"
    }, React__default.createElement(TruncateTypographyStyled, {
      variant: "subtitle2"
    }, item.label), React__default.createElement(ColorBoxStyled, {
      sx: {
...
var mixLegendColors = function mixLegendColors(colorsArr) {
  ...
  formatColors.forEach(function (color, i) {
    if (i !== formatColors.length - 1) {
      var color1 = new tinycolor.TinyColor(color);
      var color2 = new tinycolor.TinyColor(formatColors[i + 1]);
...
var Legend = function Legend(_ref) {
  ...
  return React__default.createElement(StaticLegend, Object.assign({}, otherProps, {
    items: legendItems
  }));
};
...
var GapBoxStyled = /*#__PURE__*/styles.styled(material.Box, options$1)(function (_ref) {
  var gap = _ref.gap,
      theme = _ref.theme;
  return {
...
var GapBox = function GapBox(_ref) {
  ...
  return React__default.createElement(GapBoxStyled, Object.assign({
    gap: gap
  }, otherProps), children);
};

var TopBarStyled = /*#__PURE__*/styles.styled(material.Box)({
  position: 'fixed',
  left: 0,
  top: 0,
  right: 0,
...
var BlockingGridStyled = /*#__PURE__*/styles.styled(material.Grid)({
  position: 'fixed',
  left: 0,
  top: 0,
  right: 0,
...
var Loader = function Loader(_ref) {
  ...
  if (isLoading) {
    if (variant === 'blocking') return React__default.createElement(BlockingGridStyled, {
      container: true,
      alignItems: "center",
      justifyContent: "center",
      style: _extends({}, style)
    ...
    return React__default.createElement(TopBarStyled, {
      style: _extends({}, style)
  ...
  return React__default.createElement(material.Box, {
    ...
    return (// eslint-disable-next-line react/no-array-index-key
      React__default.createElement(React.Fragment, {
        ...
        inputRef: item,
        autoFocus: i === 0
      }), (i + 1) % seperationInterval === 0 && i !== lengthIndex && React__default.createElement(material.Typography, {
        sx: {
          fontSize: fontSize,
          mx: 1,
          my: 0
...
var BoxRootStyled = /*#__PURE__*/styles.styled(material.Box, {
  shouldForwardProp: function shouldForwardProp(prop) {
...
var IconBoxStyled = /*#__PURE__*/styles.styled(material.Box)(function (_ref) {
  var theme = _ref.theme;
  return system.experimental_sx({
    zIndex: 10,
...
var Handle = function Handle(_ref) {
  var onMouseDown = _ref.onMouseDown,
      ...
      vertical = _ref.vertical,
      size = _ref.size;
  var localTheme = material.useTheme();
  ...
  return React__default.createElement(BoxRootStyled, {
    draggable: false,
    ...
    vertical: vertical
  }, React__default.createElement(IconBoxStyled, {
    draggable: false,
    sx: _extends({
      transform: !isHorizontal ? 'translate(-40%, 0) rotate(-90deg)' : 'unset'
    }, sizeMap[size])
  }, !isCollapsed ? React__default.createElement(iconsMaterial.DragHandle, {
    sx: {
      color: 'primary.main',
  ...
  }) : React__default.createElement(iconsMaterial.ExpandLess, {
    sx: {
      color: 'primary.main',
      transform: 'translate(0, -5px)',
      width: 18,
...
var VerticalHandle = function VerticalHandle(_ref) {
  ...
  var _useState2 = React.useState(minDraggableSize * 2),
  ...
  var expandWidth = React.useMemo(function () {
    return 30 / 100 * wrapperSize;
  }, [wrapperSize]);
  var expandHeight = React.useMemo(function () {
    return expandWidth;
  }, [expandWidth]);
...
var _styled;
var BoxMessageStyled = /*#__PURE__*/styles.styled(material.Box)((_styled = {
  display: 'flex',
  alignItems: 'center',
  flexWrap: 'wrap'
...
var SnackbarProvider = function SnackbarProvider(_ref) {
  ...
  var handleMessage = function handleMessage(svr, msg) {
    switch (svr) {
      ...
      case 'info':
        return React__default.createElement(BoxMessageStyled, null, React__default.createElement(InfoOutlinedIcon, {
          className: "messageIcon"
        }), msg);

      case 'success':
        return React__default.createElement(BoxMessageStyled, null, React__default.createElement(CheckCircleOutlinedIcon, {
          className: "messageIcon"
        }), msg);

      case 'warning':
        return React__default.createElement(BoxMessageStyled, null, React__default.createElement(ReportProblemOutlinedIcon, {
          className: "messageIcon"
        }), msg);

      case 'error':
        return React__default.createElement(BoxMessageStyled, null, React__default.createElement(ErrorOutlineOutlinedIcon, {
          className: "messageIcon"
        }), msg);
  ...
  var handleTransitionComponent = function handleTransitionComponent(transitionType) {
    ...
    switch (transitionType) {
      ...
      case 'grow':
        transition = material.Grow;
        break;

      case 'slide':
        transition = material.Slide;
        break;
  ...
  }, children, React__default.createElement(material.Snackbar // {...existingSnackbarProps}
  , {
    ...
    action: newAction && React__default.createElement(material.Button, {
      variant: "outlined",
      size: "small",
      sx: {
...
var defaultTheme$1 = /*#__PURE__*/styles.createTheme();
var dhiSharedTheme = /*#__PURE__*/styles.createTheme( /*#__PURE__*/utils.deepmerge(defaultTheme$1, {
...
var DHIThemeProvider = function DHIThemeProvider(_ref) {
  ...
  var theme = React.useMemo(function () {
    var themeWithOverrides = utils.deepmerge(_extends({}, dhiSharedTheme), overrides);
    return styles.createTheme(themeWithOverrides);
  }, [overrides]);
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(styles.ThemeProvider, {
    theme: theme
  }, React__default.createElement(CssBaseline, null), children));
};

var CustomSlider = /*#__PURE__*/styles.styled(material.Slider)(function (_ref) {
  var theme = _ref.theme;
  return {
    '&.MuiSlider-root': {
      height: 8
...
var TypographyAnnotations = /*#__PURE__*/styles.styled(material.Typography)({
  fontSize: 12,
  fontWeight: 600
});
...
var TimestepPlayer = function TimestepPlayer(_ref) {
  ...
  return React__default.createElement(material.Box, {
  ...
  }, timesteps && timesteps.length > 0 && React__default.createElement(material.Grid, {
    container: true,
    alignItems: "center"
    ...
    color: "secondary",
    size: "large"
  }, play ? React__default.createElement(iconsMaterial.PauseCircleFilled, {
    sx: {
      height: 38,
      width: 38
    }
  }) : React__default.createElement(iconsMaterial.PlayCircleFilled, {
    sx: {
      height: 38,
      width: 38
    }
    ...
    ml: 1,
    mr: 3
  }, React__default.createElement(CustomSlider, {
    value: step,
    step: 1,
    min: 0,
    ...
    display: "flex",
    justifyContent: "space-between"
  }, React__default.createElement(TypographyAnnotations, {
    color: "secondary"
  }, timesteps[0] && formatDate(timesteps[0], type)), React__default.createElement(TypographyAnnotations, {
    color: "secondary"
...
exports.ArrowDownIconStyled = ArrowDownIconStyled;
exports.BarLegend = BarLegend;
exports.BlockingGridStyled = BlockingGridStyled;
exports.BoxDisabledStyled = BoxDisabledStyled;
exports.BoxMessageStyled = BoxMessageStyled;
exports.ButtonBaseStyled = ButtonBaseStyled;
exports.CalendarBox = CalendarBox;
exports.CalendarItem = CalendarItem;
exports.CalendarItemStyled = CalendarItemBox;
exports.Card = Card;
exports.CardRootStyled = CardRootStyled;
exports.CategoricalBarLegend = CategoricalBarLegend;
exports.CollapsableBox = CollapsableBox;
exports.ColorBoxStyled = ColorBoxStyled;
exports.ContinuousLegend = Legend;
...
exports.GapBox = GapBox;
exports.GapBoxStyled = GapBoxStyled;
exports.IconBoxStyled = IconBoxStyled;
exports.ImgCardStyled = ImgCardStyled;
exports.ImgLegendStyled = ImgLegendStyled;
exports.LegendBase = LegendBase;
exports.Loader = Loader;
exports.MultiField = MultiField;
exports.ResizeHandle = VerticalHandle;
exports.SnackbarProvider = SnackbarProvider;
exports.StaticLegend = StaticLegend;
exports.ThemeProvider = DHIThemeProvider;
exports.TimestepPlayer = TimestepPlayer;
exports.TimestepSliderStyled = CustomSlider;
exports.TopBarBoxStyled = TopBarStyled;
exports.TruncateTypographyStyled = TruncateTypographyStyled;
exports.TypographyAnnotationsStyled = TypographyAnnotations;
exports.mixLegendColors = mixLegendColors;
exports.useBelow = useBelow;
exports.useDebounce = useDebounce;
exports.useLocalStorage = useLocalStorage;
exports.useSessionStorage = useSessionStorage;
exports.useSnackbar = useSnackbar;
//# sourceMappingURL=react-components-lab.cjs.development.js.map
