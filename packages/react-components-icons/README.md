...
<h1 align="left">@dhi/react-components-icons</h1>
...
Our library is showcased on the [icons Storybook](https://storybooklab.z16.web.core.windows.net/)
...
```
// with npm
npm install @dhi/react-components-icons

// with yarn
yarn add @dhi/react-components-icons
```
